...
void THNN_(SpatialReplicationPadding_updateOutput)(
 ...
 hipLaunchKernelGGL( SpatialReplicationPadding_updateOutput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
...
void THNN_(SpatialReplicationPadding_updateGradInput)(
 ...
 hipLaunchKernelGGL( SpatialReplicationPadding_updateGradInput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
