...
void THNN_(SpatialReflectionPadding_updateOutput)(THCState *state,
 ...
 hipLaunchKernelGGL( SpatialReflectionPadding_updateOutput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
...
void THNN_(SpatialReflectionPadding_updateGradInput)(
 ...
 hipLaunchKernelGGL( SpatialReflectionPadding_updateGradInput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
