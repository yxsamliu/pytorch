...
class NetTestDummyOp final : public OperatorBase {
 public:
  ...
  // Simulate HIP operator behavior
  bool HasAsyncPart() const override {
    return debug_def().device_option().device_type() == PROTO_HIP;
  }
...
REGISTER_HIP_OPERATOR(NetTestDummy, NetTestDummyOp);
REGISTER_CPU_OPERATOR(NetTestDummy2, NetTestDummyOp);
REGISTER_HIP_OPERATOR(NetTestDummy2, NetTestDummyOp);
