...
void THNN_(TemporalReflectionPadding_updateOutput)(THCState *state,
 ...
 hipLaunchKernelGGL( TemporalReflectionPadding_updateOutput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
...
void THNN_(TemporalReflectionPadding_updateGradInput)(
 ...
 hipLaunchKernelGGL( TemporalReflectionPadding_updateGradInput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
