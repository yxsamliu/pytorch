                                       ...
                                       real init, BinaryOp binary_op)
{
 ...
 hipLaunchKernelGGL( THCTensor_kernel_scanOuterDim<real>, dim3(grid), dim3(threads), 0, THCState_getCurrentStream(state), 
                                           ...
                                           BinaryFunction binary_op)
{
 ...
 hipLaunchKernelGGL( THCTensor_kernel_scanInnermostDim<real, 16, 32>, dim3(grid), dim3(threads), 0, THCState_getCurrentStream(state), 
