...
struct sigmoid_updateGradInput_functor {
  __device__ inline void operator()(T* gradInput, const T *output, const T *gradOutput) const {
...
struct sigmoid_updateGradInput_functor<half> {
  __device__ inline void operator()(half* gradInput, const half *output, const half *gradOutput) const {
