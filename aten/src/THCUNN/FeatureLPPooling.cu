...
template <typename T,
          int Width,
          int Stride,
          T (*PowerFunc)(const T in, const T power),
          T (*RootFunc)(const T in, const T power)>
__global__ void
...
#define L2_STRIDE_CASE(STRIDE, WIDTH)                                   \
  case STRIDE:                                                          \
    detail::featureLPPoolingUpdateOutput<T, WIDTH,                              \
                                 STRIDE,                                \
                                 detail::power2,                        \
...
#define L2_STRIDE_CASE(STRIDE, WIDTH)                                   \
  case STRIDE:                                                          \
    detail::featureLPPoolingUpdateGradInput<                                    \
