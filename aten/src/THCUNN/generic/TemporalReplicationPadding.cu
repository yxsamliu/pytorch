...
void THNN_(TemporalReplicationPadding_updateOutput)(
 ...
 hipLaunchKernelGGL( TemporalReplicationPadding_updateOutput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
...
void THNN_(TemporalReplicationPadding_updateGradInput)(
 ...
 hipLaunchKernelGGL( TemporalReplicationPadding_updateGradInput<real>, dim3(gridSize), dim3(blockSize), 0, THCState_getCurrentStream(state), 
