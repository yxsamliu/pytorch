           ...
           int owidth, int oheight)
{
 ...
 hipLaunchKernelGGL( MaxUnpoolForward<real> ,  dim3(GET_BLOCKS(count)), dim3(CUDA_NUM_THREADS), 0, THCState_getCurrentStream(state) , 
           ...
           int owidth, int oheight)
{
 ...
 hipLaunchKernelGGL( MaxUnpoolBackward<real> ,  dim3(GET_BLOCKS(count)), dim3(CUDA_NUM_THREADS), 0, THCState_getCurrentStream(state) , 
