...
bool CosineSimilarityOp<float, HIPContext>::RunOnDevice() {
 ...
 hipLaunchKernelGGL( DotProductKernel, 
      ...
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), X_data, X_data, x2);
 hipLaunchKernelGGL( DotProductKernel, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), Y_data, Y_data, y2);
 hipLaunchKernelGGL( DotProductKernel, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), X_data, Y_data, result_data);
...
bool CosineSimilarityGradientOp<float, HIPContext>::RunOnDevice() {
 ...
 hipLaunchKernelGGL( DotProductKernel, 
      ...
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), X_data, X_data, xn);
 ...
 hipLaunchKernelGGL( DotProductKernel, 
      ...
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), Y_data, Y_data, yn);
 ...
 hipLaunchKernelGGL( DotProductKernel, 
      ...
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), X_data, Y_data, xy);
 ...
 hipLaunchKernelGGL( BatchedMul<float>, 
      ...
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), Y_data, scale, dX_data);
 hipLaunchKernelGGL( Scale2AxpyScale<float>, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), scale, xy, xn, axpy_scale);
 hipLaunchKernelGGL( BatchedAxpy<float>, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), axpy_scale, X_data, dX_data);
  // dY
 hipLaunchKernelGGL( BatchedMul<float>, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), X_data, scale, dY_data);
 hipLaunchKernelGGL( Scale2AxpyScale<float>, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), scale, xy, yn, axpy_scale);
 hipLaunchKernelGGL( BatchedAxpy<float>, 
      dim3(::min(N, CAFFE_MAXIMUM_NUM_BLOCKS)),
      dim3(CAFFE_HIP_NUM_THREADS),
      0,
      context_.hip_stream(), static_cast<const int>(N), static_cast<const int>(D), axpy_scale, Y_data, dY_data);
