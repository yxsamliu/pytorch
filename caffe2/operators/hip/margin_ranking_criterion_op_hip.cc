...
bool MarginRankingCriterionOp<HIPContext>::RunOnDevice() {
 ...
 hipLaunchKernelGGL( MRCKernel, dim3(CAFFE_GET_BLOCKS(X1.size())), dim3(CAFFE_HIP_NUM_THREADS),
...
bool MarginRankingCriterionGradientOp<HIPContext>::RunOnDevice() {
 ...
 hipLaunchKernelGGL( MRCGradientKernel, dim3(CAFFE_GET_BLOCKS(X1.size())), dim3(CAFFE_HIP_NUM_THREADS),
                      0, context_.hip_stream(), 
