           ...
           int outputWidth)
{
 ...
 hipLaunchKernelGGL( nearest_neighbor_4d_kernel<real, accreal> , dim3(THCCeilDiv(num_kernels, num_threads)), dim3(num_threads),
	   ...
	   int outputWidth)
{
 ...
 hipLaunchKernelGGL( nearest_neighbor_4d_kernel_backward<real, accreal> , dim3(THCCeilDiv(num_kernels, num_threads)),
